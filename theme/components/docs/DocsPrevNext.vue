...
<template>
  <div v-if="prev || next" class="group mt-8 flex flex-row-reverse items-center justify-between gap-4 font-medium leading-7">
    <div class="flex w-full flex-1 items-center justify-start">
      <NuxtLink v-if="prev" :to="prev.slug" class="transition-base surface-border hover:surface-border-hover hover:text-secondary-hover group inline-flex w-full items-center justify-start truncate rounded-xl border px-4 py-2.5 transition">
    ...
    <div class="order-first flex flex-1 justify-end">
      <NuxtLink v-if="next" :to="next.slug" class="transition-base surface-border hover:surface-border-hover hover:text-secondary-hover group inline-flex w-full items-center justify-end truncate rounded-xl border px-4 py-2.5 transition">
