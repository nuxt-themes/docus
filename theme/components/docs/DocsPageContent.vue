...
<template>
  <div id="docus-docs-page-content" class="relative flex flex-col-reverse gap-8 lg:grid lg:grid-cols-12">
    ...
    <div
      ...
      class="surface surface-blurry top-header sticky -mx-4 -mt-8 flex items-center overflow-x-hidden border-b border-gray-200 px-4 dark:border-gray-800 sm:-mx-6 sm:px-6 lg:col-span-3 lg:mx-0 lg:max-h-[calc(100vh-var(--layout-height))] lg:self-start lg:border-none lg:px-0 lg:pt-8"
    >
      <div>
