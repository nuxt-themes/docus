<template>
  <svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 410 404">
    ...
    <path d="M399.641 59.525l-183.998 329.02c-3.799 6.793-13.559 6.833-17.415.073L10.582 59.556C6.38 52.19 12.68 43.266 21.028 44.76l184.195 32.923c1.175.21 2.378.208 3.553-.006l180.343-32.87c8.32-1.517 14.649 7.337 10.522 14.719z" fill="url(#paint0_linear)" />
