  ...
  <div v-show="open" class="fixed z-50 overflow-hidden rounded-md shadow group bg-gray-50 dark:bg-gray-800 bottom-6 left-6 w-36">
    ...
    <ul class="p-2">
      <li class="flex items-center pb-1 font-medium">
        <button type="button" class="relative inline-flex items-center justify-center flex-shrink-0 w-10 h-5 rounded-full cursor-pointer group focus:outline-none" aria-pressed="false" @click="$docus.ui.draft = !$docus.ui.draft">
          ...
          <span aria-hidden="true" :class="drafts ? 'translate-x-5' : 'translate-x-0'" class="absolute left-0 inline-block w-5 h-5 transition-transform duration-200 ease-in-out transform bg-white border border-gray-200 rounded-full shadow pointer-events-none"></span>
        </button>
        <span class="ml-2 cursor-pointer" @click="$docus.ui.draft = !$docus.ui.draft">Drafts</span>
      </li>
      <li class="flex items-center font-medium">
        <button type="button" class="relative inline-flex items-center justify-center flex-shrink-0 w-10 h-5 rounded-full cursor-pointer group focus:outline-none" aria-pressed="false" @click="$docus.ui.slots = !$docus.ui.slots">
          ...
          <span aria-hidden="true" :class="slots ? 'translate-x-5' : 'translate-x-0'" class="absolute left-0 inline-block w-5 h-5 transition-transform duration-200 ease-in-out transform bg-white border border-gray-200 rounded-full shadow pointer-events-none"></span>
        </button>
