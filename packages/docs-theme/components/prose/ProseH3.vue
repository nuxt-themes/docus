...
h3 {
  @apply mt-8 mb-4 scroll-mt-[calc(var(--header-height)+4.5rem)] text-xl font-semibold leading-snug tracking-tight u-text-gray-900 sm:scroll-mt-[calc(var(--header-height)+2rem)];
}
