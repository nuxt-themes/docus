...
h4 {
  @apply mt-8 mb-4 scroll-mt-[calc(var(--header-height)+4.5rem)] text-lg font-semibold leading-snug tracking-tight sm:scroll-mt-[calc(var(--header-height)+2rem)];
}
