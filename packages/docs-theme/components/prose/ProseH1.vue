...
h1 {
  @apply u-text-gray-900 mt-8 mb-4 scroll-mt-[calc(var(--header-height)+4.5rem)] text-3xl font-semibold leading-snug tracking-tight sm:scroll-mt-[calc(var(--header-height)+2rem)];
}
