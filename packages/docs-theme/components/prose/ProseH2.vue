...
h2 {
  @apply mt-8 mb-4 scroll-mt-[calc(var(--header-height)+4.5rem)] text-2xl font-semibold leading-snug tracking-tight text-gray-900 dark:text-white sm:scroll-mt-[calc(var(--header-height)+2rem)];
}
