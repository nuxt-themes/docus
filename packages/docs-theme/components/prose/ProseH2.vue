...
h2 {
  @apply mt-[1.25em] mb-[0.5em] -scroll-mt-16 text-2xl font-semibold leading-snug tracking-tight text-gray-900 dark:text-white;
}
...
h2 > a {
  @apply relative border-b border-dashed border-transparent text-inherit;
