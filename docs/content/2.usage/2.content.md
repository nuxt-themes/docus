...
Once you've setup your documentation, you can directly start writing Markdown inside the `content/` directory.


```md [content/index.md]
---
title: 'Introduction'
description: 'Empower your Nuxt application with this awesome module.'
