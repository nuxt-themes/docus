...
::button-link[Create a repo with the Docus starter]{size="medium" blank href="https://github.com/nuxtlabs/docus-starter/generate"}
...
::button-link[Create and deploy using Vercel]{blank href="https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fnuxtlabs%2Fdocus-starter"}
