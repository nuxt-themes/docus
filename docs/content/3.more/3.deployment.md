...
Like others, [DigitalOcean Apps](https://www.digitalocean.com/products/app-platform/) provides an easy way to deploy static websites like Docus.
...
Once you loggen in, you should connect your project repository with DigitalOcean. Connect your project and select the main branch, DigitalOcean will deploy this branch.
...
Finally, choose a name for your website and wait for deployment to complete.