...
If you have a CI, you need to create `pages` stage and specify generated files `public` artifacts
...
If you don't have a CI you will need to create a new one. Create a new file called `.gitlab-ci.yml` in root directory of your project and paste the following content into the file.
