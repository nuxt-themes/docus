...
Cloudflare Pages is a JAMstack platform to collaborate and deploy websites. Whit an effortless Git integration, You can deploy Docus on Cloudflare Pages within minutes.

Visit your Cloudflare Pages section in your account dashboard and import your ptoject into Cloudflare.
...
After selecting your git repository, Select `Nuxt` for **"Framework preset"**. By selecting `Nuxt` Cloudflare automatically enables correct settings for your deployment.
When your project has been imported, all subsequent pushes to main branch will generates a deployment.
